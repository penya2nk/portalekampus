	...
	*/
	...
	public function onLoad($param) {		
        ...
        if (!$this->IsPostBack&&!$this->IsCallBack) {	
            if (!isset($_SESSION['currentPageProfilMahasiswa'])||$_SESSION['currentPageProfilMahasiswa']['page_name']!='dw.kemahasiswaan.ProfilMahasiswa') {
				$_SESSION['currentPageProfilMahasiswa']=array('page_name'=>'dw.kemahasiswaan.ProfilMahasiswa','page_num'=>0,'DataMHS'=>array(),'activeviewindex'=>0);												
			}
    ...
    public function changeView ($sender,$param) {                
        try {
            ...
            $datamhs=$r[1];
            if ($datamhs['iddosen_wali'] != $iddosen_wali) {
                unset($_SESSION['currentPageProfilMahasiswa']);
