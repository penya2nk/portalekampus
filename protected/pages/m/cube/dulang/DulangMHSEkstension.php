...
class DulangMHSEkstension Extends MainPageM {		
    ...
    public function populateData($search=false) {
        ...
        if ($search) {
            ...
            $str = "SELECT vdm.no_formulir,vdm.nim,vdm.nirm,vdm.nama_mhs,vdm.iddosen_wali,d.tanggal FROM v_datamhs vdm,dulang d WHERE vdm.nim=d.nim AND d.tahun=$ta AND d.idsmt=$idsmt AND vdm.kjur='$kjur' AND vdm.idkelas='C' $str_dw $str_tahun_masuk";
