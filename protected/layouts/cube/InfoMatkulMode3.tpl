                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label"><strong>DOSEN PENGAMPU KELAS: </strong></label>
                                <div class="col-sm-8">
                                    <p class="form-control-static"><%= $this->Demik->InfoMatkul['nama_dosen2']%> [<%= $this->Demik->InfoMatkul['nidn2']%>]</p>
                                </div>                            
                            </div>
                        </div>
                    </div>
