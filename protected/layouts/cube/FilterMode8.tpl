<div id="config-tool" class="closed">
    ...
    <div id="config-tool-options">
        ...
        <br/>
        <h4 style="font-size:12px"><strong>Tahun Akademik / Tahun Masuk:</strong></h4>
        <ul id="skin-colors" class="clearfix">
            <li style="font-size:10px">
                <div class="row">
                    <div class="col-sm-6">
        ...
        <br/>
        <h4 style="font-size:12px"><strong>Semester:</strong></h4>
        <ul id="skin-colors" class="clearfix">
            <li style="font-size:10px">
               <com:TActiveDropDownList ID="tbCmbSemester" OnCallback="Page.changeTbSemester" CssClass="form-control">
					<prop:ClientSide.OnPreDispatch>
						$('loading').show();
					</prop:ClientSide.OnPreDispatch>
                   <prop:ClientSide.OnLoading>
