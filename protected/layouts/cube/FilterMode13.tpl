<div id="config-tool" class="closed">
    ...
    <div id="config-tool-options">
        ...
        <br/>
        <h4 style="font-size:12px"><strong>Semester Masuk:</strong></h4>
        <ul id="skin-colors" class="clearfix">
            <li style="font-size:10px">
               <com:TActiveDropDownList ID="tbCmbSemesterMasuk" OnCallback="Page.changeTbSemesterMasuk" CssClass="form-control">
					<prop:ClientSide.OnPreDispatch>
						$('loading').show();
					</prop:ClientSide.OnPreDispatch>
                   <prop:ClientSide.OnLoading>
