...
<com:THead>
	...
	<meta name="description" content="Portal E-Kampus v1.1">        
	<link href="<%=$this->Page->Theme->baseUrl%>/assets/css/icons/icomoon/styles.css" rel="stylesheet" type="text/css">
    <link href="<%=$this->Page->Theme->baseUrl%>/assets/css/icons/fontawesome/styles.min.css" rel="stylesheet" type="text/css">    
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown dropdown-user visible">
                <a class="dropdown-toggle" data-toggle="dropdown">
                    <img src="<%=$this->Page->Theme->baseUrl%>/assets/images/placeholder.jpg" alt="">
...
<!-- /main navbar -->
<!-- Second navbar -->
<div class="navbar navbar-inverse bg-green-300 navbar-xs" id="navbar-second">
    ...
    <div class="navbar-collapse collapse" id="navbar-second-toggle">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown mega-menu mega-menu-wide visible">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-puzzle4 position-left"></i> DATA MASTER <span class="caret"></span></a>

                <div class="dropdown-menu dropdown-content">
                    <div class="dropdown-content-body">
                        <div class="row">
                            <div class="col-md-3">
                                <span class="menu-heading underlined">KEUANGAN</span>
                                <ul class="menu-list">
                                    <li>
                                ...
                                <ul class="menu-list">
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li class="active"><a href="components_page_header.html">Page header</a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li>
                <a href="changelog.html">
                    ...
                    Changelog
                    <span class="label label-inline position-right bg-success-400">1.2</span>
                </a>
            </li>
...
<div class="page-header page-header-lg panel" style="padding-bottom: 0;">    
...
<script type="text/javascript" src="<%=$this->Page->Theme->baseUrl%>/assets/js/core/app.js"></script>
