...
class CTranskripFinal extends MainPageM {	
	public function onLoad ($param) {
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {			
            ...
            if (!isset($_SESSION['currentPageTranskripFinal'])||$_SESSION['currentPageTranskripFinal']['page_name']!='m.Akademik.TranskripFinal') {					
                $_SESSION['currentPageTranskripFinal']=array('page_name'=>'m.Akademik.TranskripFinal','page_num'=>0,'search'=>false,'tanggal_terbit'=>'none');												
            }
