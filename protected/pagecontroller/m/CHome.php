...
class CHome extends MainPageM {    
    ...
    public function populateData () {
        ...
        $persenmendaftartahunini=number_format(($mendaftartahunini/$mendaftartahunlalu)*100,2);
        $this->PersentaseMendaftarTahunINI=$persenmendaftartahunini;
        $persendulangtahunini=number_format(($dulangtahunini/$dulangtahunlalu)*100,2);
